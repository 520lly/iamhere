...
curl --data '{"name":"2雪窦山 徐凫岩瀑布","description":"喜欢瀑布下沐浴水汽的感觉","province":"Zhengjiang","city":"Ningbo","district":"Fenghua","address1":"浙江省宁波市奉化区","address2":"","category":1,"type":0,"latitude":2.7039399637,"longitude":121.1754884604,"altitude":0,"radius":50.00}' -X POST http://$IP:8080/areas/${1:-""}
curl -X GET "http://$IP:8080/areas/?debug=1"
