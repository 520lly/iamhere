...
#curl --data '{"nickname":"mnma","password":"12345ddqw", "email":"jacking.wang.wjq@gmail.com","firstname":"jianqing","lastname":"wang","phonenumber":"13167016112","birthday":"19990919","gender":"male"}' -X POST "http://$IP:8080/accounts"
curl -X GET "http://$IP:8080/api/v1/accounts/?debug=1"
curl --data '{"nickname":"mnma","password":"12345", "email":"jacking.wang.wjq@gmail.com","firstname":"jianqing","lastname":"wang","phonenumber":"13167016112","birthday":"19990919","gender":"male"}' -X ${1:-"POST"} "http://$IP:8080/api/v1/accounts/${2:-"register"}"
exit
